...
namespace ReactVentas.Controllers
{
    ...
    public class VentaController : ControllerBase
    {
        ...
        public VentaController(FERRETERIA_REACTContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Productos(string busqueda)
        {
            ...
            try
            {
                lista = await _context.Productos
                    .Where(p => p.EsActivo.HasValue && p.EsActivo.Value &&
                                string.Concat(p.Codigo.ToLower(), p.Marca.ToLower(), p.Descripcion.ToLower())
        ...
        // Listar ventas según los filtros de búsqueda
        [HttpGet]
        [Route("Listar")]
