// Importaciones y configuración inicial para Chart.js
// Se importan los componentes necesarios de Chart.js y se registra la configuración
...
// Datos iniciales para el gráfico de Donut, utilizado cuando no hay resultados disponibles
...
// Datos iniciales para el gráfico de Barras, utilizado cuando no hay resultados disponibles
    ...
    return (
        <>
            <div className="row">
                ...
                {/* Tarjeta de Ingresos por Ventas */}
                <div className="col-xl-3 col-md-6 mb-4">
            ...
            <div className="row">
                ...
                {/* Gráfico de Donut para productos más vendidos */}
