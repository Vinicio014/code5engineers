...
// Definición del objeto modeloUsuario con valores iniciales
const modeloUsuario = {
    idUsuario: 0,
    nombre : "",
    correo :"",
...
// Componente principal Usuario
const Usuario = () => {
    // Declaración de estados con hooks
    ...
    const handleChange = (e) => {
        ...
        let value;
        // Verifica el tipo de input para asignar correctamente el valor
        ...
        // Actualiza el estado del usuario con el nuevo valor
        setUsuario({
            ...usuario,
            [e.target.name]: value
        })
    ...
    // Función para obtener la lista de roles desde la API
    ...
    useEffect(() => {
        ...
        // Configuración de las columnas para la tabla de usuarios
    const columns = [
        {
            name: 'Nombre',
        ...
        },
        {
            ...
            sortable: true,
            // Muestra una etiqueta con el estado del usuario (Activo o No Activo)
            cell: row => {
                let clase;
    ...
    // Cierra el modal y reinicia el estado del usuario
    const cerrarModal = () => {
        setUsuario(modeloUsuario)
        setVerModal(!verModal);
    }

    // Guarda los cambios del usuario (agregar o editar)
