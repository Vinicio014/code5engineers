...
const HistorialVenta = () => {
    // Estados para manejar las fechas de inicio y fin, el número de venta y el criterio de búsqueda
    const [fechaInicio, setFechaInicio] = useState(new Date());
    const [fechaFin, setFechaFin] = useState(new Date());
    const [nroVenta,setNumeroVenta] = useState("")
    const [buscarPor, setBuscarPor] = useState("fecha")
    // Estado para controlar la visibilidad del modal y para almacenar los detalles de una venta seleccionada
    const [verModal,setVerModal] = useState(false)
    const [detalleVenta, setDetalleVenta] = useState({})
    // Estado para almacenar las ventas obtenidas de la búsqueda
    const [ventas,setVentas] = useState([])

    // Función para buscar ventas en la API según los parámetros seleccionados
    const buscarVenta = () => {
        ...
        // Llamada a la API para listar ventas
    ...
    // Función para mostrar el modal con los detalles de la venta seleccionada
    ...
    return (
        <>
            ...
            {/* Modal para mostrar los detalles de una venta seleccionada */}
