// Importación de componentes de Reactstrap para el diseño de la interfaz,
// y librerías externas como DatePicker, Swal y XLSX para manejo de fechas,
// alertas y exportación de datos a Excel.
...
// Modelo inicial del estado "ventas" con estructura de campos vacíos para los datos de venta.
const modeloInicio = [{
    fechaRegistro : "",
    numeroDocumento: "",
    tipoDocumento: "",
...
// Componente principal de Reporte de Ventas
const ReporteVenta = () => {
    //Definición de estados: para fechas, estado de carga y datos de ventas.
    const [fechaInicio, setFechaInicio] = useState(new Date());
    const [fechaFin, setFechaFin] = useState(new Date());
    const [pendiente, setPendiente] = useState(false);
    const [ventas, setVentas] = useState(modeloInicio)

    // Función para buscar los datos de ventas filtrados por fecha
    const buscar = () => {
    ...
    // Definición de las columnas de la tabla para los datos de ventas
    const columns = [
        {
            name: 'Fecha Registro',
    ...
    // Función para exportar los datos de ventas a un archivo Excel
    const exportarExcel = () => {
