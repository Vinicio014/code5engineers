...
{
    public partial class FERRETERIA_REACTContext : DbContext
    {
        public FERRETERIA_REACTContext()
        {
        }

        public FERRETERIA_REACTContext(DbContextOptions<FERRETERIA_REACTContext> options)
            : base(options)
        {
        }
